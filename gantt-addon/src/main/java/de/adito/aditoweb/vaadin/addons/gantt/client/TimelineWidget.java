...
import static de.adito.aditoweb.vaadin.addons.gantt.client.shared.GanttUtil.getBoundingClientRectLeft;
import static de.adito.aditoweb.vaadin.addons.gantt.client.shared.GanttUtil.getBoundingClientRectRight;
import static de.adito.aditoweb.vaadin.addons.gantt.client.shared.GanttUtil.getBoundingClientRectWidth;
    ...
    private String addMonthBlock(String currentMonth, Date date) {
        ...
        return addBlock(currentMonth, String.valueOf(month), date, monthRowData, new Operation() {
            ...
            public void run(String target, String key, Date date) {
                addMonthBlock(key, formatMonthCaption(month, date) + " " + formatYearCaption(year, date));
            }
        });
    }
