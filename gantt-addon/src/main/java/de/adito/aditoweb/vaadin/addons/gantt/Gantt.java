...
import de.adito.aditoweb.vaadin.addons.gantt.client.shared.GanttServerRpc;
import de.adito.aditoweb.vaadin.addons.gantt.client.shared.GanttState;
...
public class Gantt extends AbstractComponent implements HasComponents {
    ...
    protected StepComponent createStepComponent(Step step) {
        return stepComponentFactory.create(this, step);
    }
    ...
    public AbstractStepComponent getStepComponent(AbstractStep step) {
    ...
    public class PredecessorChangeEvent extends Event {
    ...
    public void setStepComponentFactory(StepComponentFactory stepComponentFactory) {
