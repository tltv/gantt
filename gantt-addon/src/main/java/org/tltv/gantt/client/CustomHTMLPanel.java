...
/**
 * Same as {@link HTMLPanel} but makes HTMLPanel(Element) constructor public.
 */
public class CustomHTMLPanel extends ComplexPanel {
     ...
     *            the panel's HTML
     */
    public CustomHTMLPanel(@IsSafeHtml String html) {
        /*
    ...
    public CustomHTMLPanel(String tag, @IsSafeHtml String html) {
     ...
     */
    public CustomHTMLPanel(Element elem) {
        setElement(elem);
    }
